        ...
        async with aiohttp.ClientSession() as session:
            async with session.request(
                ...
                if r.status == 200:
                    ...
                    print(f'Successfully logged in as {data["nameOnPlatform"]} ({data["userId"]}).')
                else:
...
ubi = UbisoftInstance(
    email="fraggedloser@gmail.com", # This was a Glacier account that was wiped, replace with your own account details.
    password="respect247"
)
